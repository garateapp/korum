 ...
 * @see app/Http/Controllers/GoogleCalendarController.php:21
 ...
 * @see app/Http/Controllers/GoogleCalendarController.php:36
...
const GoogleCalendarController = { connect, callback, sync }
