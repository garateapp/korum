...
export default function Edit({ auth, meeting, departments, meetingTypes }) {
    ...
    return (
        <AuthenticatedLayout header="Editar Reunión">
            <Head title={`Editar ${meeting.code}`} />

            <div className="flex justify-between items-center mb-6">
                <div>
                    <h2 className="text-2xl font-bold text-gray-800">Editar Reunión: {meeting.code}</h2>
                    <p className="text-sm text-gray-500">Modifica los datos generales de la reunión</p>
                </div>
                ...
                <form onSubmit={submit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="form-control w-full md:col-span-2">
                            <label className="label"><span className="label-text font-semibold">Estado de la reunión</span></label>
                            <select
                        ...
                        <div className="form-control w-full md:col-span-2">
                            <label className="label">
                                <span className="label-text font-semibold">Ubicación física o enlace</span>
                            </label>
                            <input
                                type="text"
                    ...
                    <div className="flex justify-end gap-2">
                        <Link href={route('meetings.show', meeting.id)} className="btn btn-ghost">Cancelar</Link>
